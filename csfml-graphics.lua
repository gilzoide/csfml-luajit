...
int sfCircleShape_getPointCount(const sfCircleShape * shape);
sfVector2f sfCircleShape_getPoint(const sfCircleShape * shape, int index);
void sfCircleShape_setRadius(sfCircleShape * shape, float radius);
float sfCircleShape_getRadius(const sfCircleShape * shape);
void sfCircleShape_setPointCount(sfCircleShape * shape, int count);
...
int sfConvexShape_getPointCount(const sfConvexShape * shape);
sfVector2f sfConvexShape_getPoint(const sfConvexShape * shape, int index);
void sfConvexShape_setPointCount(sfConvexShape * shape, int count);
void sfConvexShape_setPoint(sfConvexShape * shape, int index, sfVector2f point);
...
sfFont * sfFont_createFromMemory(const void * data, int sizeInBytes);
...
sfImage * sfImage_createFromMemory(const void * data, int size);
...
int sfRectangleShape_getPointCount(const sfRectangleShape * shape);
sfVector2f sfRectangleShape_getPoint(const sfRectangleShape * shape, int index);
...
void sfRenderTexture_drawPrimitives(sfRenderTexture * renderTexture, const sfVertex * vertices, int vertexCount, sfPrimitiveType type, const sfRenderStates * states);
...
void sfRenderWindow_drawPrimitives(sfRenderWindow * renderWindow, const sfVertex * vertices, int vertexCount, sfPrimitiveType type, const sfRenderStates * states);
...
void sfShader_setFloatUniformArray(sfShader * shader, const char * name, const float * scalarArray, int length);
void sfShader_setVec2UniformArray(sfShader * shader, const char * name, const sfGlslVec2 * vectorArray, int length);
void sfShader_setVec3UniformArray(sfShader * shader, const char * name, const sfGlslVec3 * vectorArray, int length);
void sfShader_setVec4UniformArray(sfShader * shader, const char * name, const sfGlslVec4 * vectorArray, int length);
void sfShader_setMat3UniformArray(sfShader * shader, const char * name, const sfGlslMat3 * matrixArray, int length);
void sfShader_setMat4UniformArray(sfShader * shader, const char * name, const sfGlslMat4 * matrixArray, int length);
...
sfShape * sfShape_create(int getPointCount, sfShapeGetPointCallback getPoint, void * userData);
...
int sfShape_getPointCount(const sfShape * shape);
...
int sfVertexArray_getVertexCount(const sfVertexArray * vertexArray);
